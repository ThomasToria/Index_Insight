...
\begin{minipage}[c]{0.44\textwidth}
    \centering
\includegraphics[width=0.72\linewidth]{Figures/universite-lorraine-logo.png}
\end{minipage}
\hfill
\begin{minipage}[c]{0.44\textwidth}
    \centering
\includegraphics[width=0.72\linewidth]{Figures/idmc-logo.png}
\end{minipage}
...
\texttt{nature\_initiative\_normalisee} & String & Deterministically normalised initiative type. \\
